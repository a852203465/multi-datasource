...
public class SecondaryRedisConfig extends CachingConfigurerSupport {
    ...
    public SecondaryRedisConfig(RedisConnectionFactory redisConnectionFactory, CacheProperties cacheProperties) {
     ...
     */
    @Bean("rtCliSec")
    public RedisTemplate<String, Object> redisTemplate(@Qualifier("secondaryRedis") RedisConnectionFactory redisConnectionFactory) {
     ...
     */
    @Bean(name = "redisCliSec")
    public RedisUtils redisCliSec(@Qualifier("rtCliSec") RedisTemplate<String, Object> redisTemplate) {
